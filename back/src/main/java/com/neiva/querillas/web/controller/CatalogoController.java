...
public class CatalogoController {
    ...
    @GetMapping("/estados")
    public List<ItemSimpleDTO> listarEstados(@RequestParam(required = false) String modulo) {
        String moduloFinal = (modulo != null && !modulo.isEmpty()) ? modulo : "QUERELLA";
        return estadoRepo.findByModulo(moduloFinal).stream()
