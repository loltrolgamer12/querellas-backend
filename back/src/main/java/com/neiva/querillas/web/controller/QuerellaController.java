...
public class QuerellaController {
    ...
    // 1. Crear querella
    @PostMapping
    @PreAuthorize("hasAnyRole('DIRECTOR','AUXILIAR')") // [CAMBIO] Solo DIRECTOR y AUXILIAR pueden crear
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyRole('DIRECTOR','AUXILIAR','INSPECTOR')") // [CAMBIO] Lectura para los 3 roles
    ...
    @PreAuthorize("hasAnyRole('DIRECTOR','INSPECTOR')") // [CAMBIO] DIRECTOR o INSPECTOR
